...
public class RequestToWeb {
    // Слушатель, при помощи которого отправим обратный вызов о готовности данных
    private OnRequestListener listener;

    // В конструкторе примем слушателя, а в дальнейшем передадим его асинхронной задаче
    public RequestToWeb(OnRequestListener onRequestListener) {
    ...
    public interface OnRequestListener {
        // Вызов для обновления прогресса
        void onStatusProgress(String updateProgress);

        // Вызов при завершении обработки
    ...
    private static class Requester extends AsyncTask<String, String, String> {
        ...
        private String getResourceUrl(String uri) {
            ...
            try {
                ...
                urlConnection.setReadTimeout(50000); // Установка таймаута - 10 000 миллисекунд
